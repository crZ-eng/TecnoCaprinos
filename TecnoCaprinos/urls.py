...
urlpatterns = [
    ...
    # CSV y Excel Vacunas
    path('csv-vacunas/', views.csv_vacunas, name='csv_vacunas'),
    path('excel-vacunas/', views.excel_vacunas, name='excel_vacunas'),

    # CSV y Excel En Cinta
    path('csv-en-cinta/', views.csv_en_cinta, name='csv_en_cinta'),
    path('excel-en-cinta/', views.excel_en_cinta, name='excel_en_cinta'),

    # CSV y Excel Enfermas
    path('csv-enfermas/', views.csv_enfermas, name='csv_enfermas'),
    path('excel-enfermas/', views.excel_enfermas, name='excel_enfermas'),

    # CSV y Excel Producción
